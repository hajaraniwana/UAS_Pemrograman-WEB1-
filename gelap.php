...
<html lang="en">
  ...
  <body class="bodydark">
    ...
    <h1 style="text-align: center; padding-top: 100px; color: white;">let's see your gallery image</h1>
    <svg class="dark" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-brightness-high" viewBox="0 0 16 16"><a href="dark.php">
